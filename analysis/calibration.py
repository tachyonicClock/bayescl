"""
Source: https://github.com/microsoft/bayesianize
License: MIT
"""
...
def calibration_curve(
    ...
    if probabilities.ndim == targets.ndim + 1:
        ...
        if top_class_only:
            ...
            # class was observed
            predictions = np.asarray(probabilities.argmax(-1), targets.dtype)
            ...
            one_hot_targets = np.asarray(
                targets[..., np.newaxis] == np.arange(num_classes), targets.dtype
            )
