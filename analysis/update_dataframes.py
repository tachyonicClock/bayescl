...
#     # extract_bayescl("logs/251104_bayescl_dc88827_cifar100.tar"),
#     extract_bayescl("logs/251110_bayescl.tar"),
#     extract_inflora("logs/250908_inflora_runs.tar.gz"),
# ):
...
# dataclass_to_df(summary_records).to_parquet("dataframe/summary.parquet")
# dataclass_to_df(time_series_records).to_parquet("dataframe/time_series.parquet")
# dataclass_to_df(calibration_records).to_parquet("dataframe/calibration.parquet")
